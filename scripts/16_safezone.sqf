/*
   ...
   *updated on 13.12.2016 by juandayz for epoch 1.6.2 community
    //all credits for infi   

How i install it?
    1. Copy paste the code of below into a file called 16_safezone.sqf - save the file.
    2. Paste this 16_safezone.sqf into mpmissioms\instance_11.chernarus\scripts\
    3. Open your init.sqf
    4. At the very bottom of the file add this line:  [] execVM "scripts\16_safezone.sqf";
